...
SKIN_REPO_COMMIT_FILE = os.path.join(DATA_DIR, "skin_repo_commit_hash.txt")
...
SKINS_REPO_COMMIT_URL = "https://api.github.com/repos/darkseal-org/lol-skins/commits/main"  
